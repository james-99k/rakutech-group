            ...
            {data.map((item)=>{
                ...
                <div className="detail__container">
                    ...
                    <div className="product__buttons">
                        ...
                        <button type="submit" className="cart__button"><i><FontAwesomeIcon icon={faShoppingCart}/></i>Add to cart</button>
                        <button type="submit" className="fav__button"><i><FontAwesomeIcon icon={faHeart}/></i></button>
